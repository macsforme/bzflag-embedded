...
DefaultDBItem	defaultDBItems[] = {
  ...
  { "radarsize",		"18",			true,	StateDatabase::ReadWrite,	NULL },
  { "mouseboxsize",		"1",			true,	StateDatabase::ReadWrite,	NULL },
  ...
  { "animatedTreads",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "shotLength",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "treadStyle",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "userTrackFade",		"0.0",			true,	StateDatabase::ReadWrite,	NULL },
  { "trackMarkCulling",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  ...
  // effects options
  { "useFancyEffects",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "spawnEffect",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "enableLocalSpawnEffect",	"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "shotEffect",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "enableLocalShotEffect",	"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "deathEffect",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "useVelOnShotEffects",	"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "landEffect",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "gmPuffEffect",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "gmPuffTime",		"1/8",			true,	StateDatabase::ReadWrite,	NULL },
  { "ricoEffect",		"0",			true,	StateDatabase::ReadWrite,	NULL },
  { "tpEffect",			"0",			true,	StateDatabase::ReadWrite,	NULL },
